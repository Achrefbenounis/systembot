...
2.const client = new Discord.Client(544871994244464680);
...
176.    {type: "CHANNEL_CREATE", logType: "CHANNEL_CREATE", limit: 4 , delay: 5000},


177.    {type: "CHANNEL_DELETE", logType: "CHANNEL_DELETE", limit: 4, delay: 5000},


178.    {type: "GUILD_MEMBER_REMOVE", logType: "MEMBER_KICK", limit: 4, delay: 5000},


179.    {type: "GUILD_BAN_ADD", logType: "MEMBER_BAN_ADD", limit: 4, delay: 5000},


180.    {type: "GUILD_ROLE_CREATE", logType: "ROLE_CREATE", limit: 5, delay: 5000},


181.    {type: "GUILD_ROLE_DELETE", logType: "ROLE_DELETE", limit: 4, delay: 5000},
...
309.  client.channels.find('id', '582093431770185745').send(` **Welcome To .. Server**  `)
...
333.client.login('NjA0Mjg2ODcwNjQxMTgwNjcy.XTrwGA.WQuvHxDn56WIT2s5tfsLNG3kNr0');
